...
import br.com.fiap.services.EnderecoOficinaServiceFactory;
...
@Path("/rest/endereco-oficina")
public class EnderecoOficinaController {

    // Instância de EnderecoService obtida da factory para Endereco de Oficina
    private final EnderecoService enderecoService = EnderecoOficinaServiceFactory.create();
        ...
        if (input.getIdEndereco() == null) {
            try {
                ...
                return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                        .entity(Map.of("mensagem", "Erro inesperado ao tentar inserir endereço da oficina"))
                        .build();
            }
        } else {
    ...
    public Response update(@PathParam("id") Long id, EnderecoDto input) {
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(Map.of("mensagem", "Erro inesperado ao tentar atualizar endereço da oficina"))
                    .build();
        }
    }
    ...
    public Response delete(@PathParam("id") Long id) {
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(Map.of("mensagem", "Erro inesperado ao tentar deletar endereço da oficina"))
                    .build();
        }
    }
}
